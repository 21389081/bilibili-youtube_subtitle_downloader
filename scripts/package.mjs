...
const zip = fileURLToPath(new URL('../dist/subtitle-text-downloader-0.1.1.zip', import.meta.url));
await mkdir(dist, { recursive: true });
if (process.platform !== 'win32') throw new Error('Run: cd extension && zip -r ../dist/subtitle-text-downloader-0.1.1.zip .');
